...
export default function HomeScreen() {
  ...
  const handleSwitchChangeManual = (val: boolean) => {
  ...
  const handleSwitchChangeAuto = (val: boolean) => {
          ...
          {selectedValue === "manual" ? (
            <View style={styles.contentCart}>
              <View style={styles.sensorValue}>
                ...
                <View style={styles.sensorValueText}>
                  <Text style={{textAlign: "center"}}>78%</Text>
                  <Text>Humidity</Text>
                </View>
              </View>
            ...
            <View style={styles.contentCart}>
              ...
              <View style={styles.customValue}>
                ...
                />
                <Text style={styles.tempText}>{Math.round(sliderValueTemp)}℃</Text>
              </View>
            </View>
          )}
        </View>
